...
It is difficult to accept it but "Server state is different from client state" and we need to let that sink in first. _why does it matter??_
...
_Stale data is better than no data at all_.
